...
class RestaurantInfoPage extends GetView<RestaurantInfoController> {
                ...
                Positioned(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      image: controller.getAllDineInRestaurantsSingle.value?.data!
                                  .first.restaurant!.image !=
                              null
                          ? DecorationImage(
                              image: MemoryImage(
                                base64Decode(
                                  controller.getAllDineInRestaurantsSingle.value
                                      ?.data![0].restaurant!.image!,
                                ),
                              ),
                              fit: BoxFit.cover,
                            )
                              ...
                              () => controller.getAllDineInRestaurantsSingle.value
                                  ...
                                  ? ListView.builder(
                                      ...
                                      itemCount: controller
                                          ...
                                          .length,
                                      itemBuilder: (context, index) {
                                        var restorantFacilitiesData = controller
                                            .getAllDineInRestaurantsSingle
                                            .value
                                            ?.data![0]
                                            .facility![index];
